...
class ISIn:
    ...
    """
    def __sec2msec(self, spiketime_sec):
        spiketime_sec = np.sort(spiketime_sec)
        spiketime_msec = spiketime_sec * 1000.0  # convert the scale to ms
        return spiketime_msec

    def plot(self, ax, spiketime_sec, n_list, threshold_msec=None):
        """
        plot ISIn histogram
        ...
        spiketime_msec = self.__sec2msec(spiketime_sec)
    ...
    def detect_burst(self, spiketime_sec, n, threshold):
        """
